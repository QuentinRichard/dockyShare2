    ...
    return (
        <div>
            ...
            <dialog id="dialog" open={props.open} ref={modalDialogRef} aria-labelledby="dialog-title"
                className="fixed inset-0 size-auto h-screen/80 w-screen max-h-none max-w-none overflow-y-auto bg-amber-50/75 backdrop:bg-amber-50/75">
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                {props.type === 'Docky' && <CreateDockyForm action={onAction} />}
                                {props.type === 'Article' && <CreateArticleForm action={onAction} />}
